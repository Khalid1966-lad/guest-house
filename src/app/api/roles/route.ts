      ...
      return NextResponse.json({
        ...
        templates: [
          ...
          },
          {
            ...
            description: "Accueil : réservations, clients et facturation de base",
            permissions: {
              canViewDashboard: true,
              canViewRooms: true,
              canViewBookings: true,
          ...
          },
          {
            name: "accountant",
            label: "Comptable",
            description: "Gestion financière : factures, dépenses et statistiques",
            permissions: {
              canViewDashboard: true,
              canViewRooms: false,
              canViewBookings: true,
          ...
          },
          {
            name: "housekeeping",
            label: "Ménage",
            description: "Gestion des chambres et de l'état des logements",
            permissions: {
