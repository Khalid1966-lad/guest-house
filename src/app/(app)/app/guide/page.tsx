    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          "Définir des rôles : Propriétaire, Gestionnaire, Personnel",
          "Contrôler les permissions de chaque rôle",
          "Propriétaire : accès total à tout",
          "Gestionnaire : peut gérer les réservations et clients",
          "Personnel : accès limité selon les permissions définies",
        ],
      },
      {
        type: "steps",
